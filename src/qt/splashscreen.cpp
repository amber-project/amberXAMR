    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString copyrightText2   = QChar(0xA9)+QString(" 2011-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Amber developers"));
	QString copyrightText3   = QChar(0xA9)+QString(" %1 ").arg(2018) + QString(tr("The Amber developers"));
