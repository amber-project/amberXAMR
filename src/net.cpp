...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Amber " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"ambertools.com", "dnsseed.ambertools.com"},
    {"amberpool.org", "dnsseed.amberpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"ambertools.com", "testnet-seed.ambertools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Amber is probably already running."), addrBind.ToString().c_str());
        else
